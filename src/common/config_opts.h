...
OPTION(osd_enable_op_tracker, OPT_BOOL, false) // enable/disable OSD op tracking
...
OPTION(throttler_perf_counter, OPT_BOOL, false) // enable/disable throttler perf counter
